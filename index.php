...
<body>
  ...
  <!-- Register modal -->
  <div class='modal fade' id='register' tabindex='-1' role='dialog' aria-labelledby='exampleModalLabel' data-backdrop='static'>
    <div class='modal-dialog' role='document'>
        <div class='modal-content'>
            ...
            <div class='modal-body'>
                <form class='form-horizontal' method='POST' action='http://localhost/school-bazaar/school-bazaar/register.php'>
...
<!-- Edit moodal -->
<div class='modal fade' id='editModal' tabindex='-1' role='dialog' aria-labelledby='exampleModalLabel' data-backdrop='static'>
  <div class='modal-dialog' role='document'>
      <div class='modal-content'>
          <div class='modal-header'>
  ...
  <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarCollapse">
      <ul class="navbar-nav mr-auto">
        <button type="button" class="btn btn-success" id="btn-register" onclick="showModal('#register')">Cadastrar Pedido</button>
      </ul>
